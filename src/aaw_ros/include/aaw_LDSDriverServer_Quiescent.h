#ifndef AAW_LDS_DRIVER_SERVER_QUIESCENT_H_
#define AAW_LDS_DRIVER_SERVER_QUIESCENT_H_
...
class AAWLDSServerQuiescent
{
public:
    AAWLDSServerQuiescent(ros::NodeHandle* nodehandle);
    ~AAWLDSServerQuiescent();
